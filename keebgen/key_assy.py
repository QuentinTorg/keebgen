...
class FaceAlignedKey(KeyAssy):
    def __init__(self, config, socket_config, r, u=1):
        ...
        cf_anchor = utils.mean_point(self.anchors_by_part('keycap')['top', 'front'].coords)
        cb_anchor = utils.mean_point(self.anchors_by_part('keycap')['top',  'back'].coords)
        ...
        cr_anchor = utils.mean_point(self.anchors_by_part('keycap')['top', 'right'].coords)
        cl_anchor = utils.mean_point(self.anchors_by_part('keycap')['top',  'left'].coords)
        ...
        center_anchor = utils.mean_point(self.anchors_by_part('keycap')['top'].coords)
